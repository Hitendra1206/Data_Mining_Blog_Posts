...
```
We see that stock prices when they open, close are at their highest, and their lowest have heavy correlation between each other, with very few outliers present, indicated by a '+'.
